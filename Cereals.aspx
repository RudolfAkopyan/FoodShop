<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Cereals.aspx.cs" Inherits="Template_Project.Page4" %>
...
<body style ="background-color:yellow">    
    <form id="form1" runat="server" style="height:100vh; width:100vw">
      ...
      <div class ="row">            
            ...
            <div class="col-sm-2">
                <asp:LinkButton ID="lnkMeat" runat="server">Meat</asp:LinkButton>
            </div>
            <div class="col-sm-2">
        ...
        <div>
            <asp:GridView ID="grdCereals" runat="server" Width="100%" AutoGenerateColumns="false" BackColor="#FFFF66" ForeColor="#FF6600">
                <Columns>
        ...
        <div style="margin-left:auto; margin-right:auto; text-align:center;">
            <asp:Button ID="btnAdd" runat="server" Text="Reset Calories" OnClick="button1_Click" ForeColor="Red"/>
        </div>
